...
```bash
        $ cmake -DCMAKE_INSTALL_PREFIX=$DESKTOP_PREFIX -DCMAKE_TOOLCHAIN_FILE=$VCPKG_FOLDER/vcpkg/scripts/buildsystems/vcpkg.cmake -DINTERNATIONALIZATION=OFF -DENABLE_PKG_CONFIGURE=OFF
```
